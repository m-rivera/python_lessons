...
<ol> 
1. Ethanol (C<sub>2</sub>H<sub>6</sub>O), doing the calculation inside a print() statement<br/>
2. cyclohexanone (C<sub>6</sub>H<sub>10</sub>O), doing the calculation in a variable which you then print<br/>
3. Nitrobenzene (C<sub>6</sub>H<sub>5</sub>NO<sub>2</sub>), using an f string<br/>
</ol>
