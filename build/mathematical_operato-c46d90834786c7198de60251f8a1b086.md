...
For the following equation write a program which calculates the equilibrium constant to 1 decimal place.

2SO<sub>2(g)</sub> + O<sub>2(g)</sub> ⇌ 2SO<sub>3(g)</sub>

Concentrations at equilibrium:
[SO<sub>3</sub>] = 5.0 × 10<sup>−2</sup> mol L<sup>−1</sup>
[O<sub>2</sub>] = 3.5 × 10<sup>−3</sup> mol L<sup>−1</sup>
[SO<sub>2</sub>] = 3.0 × 10<sup>−3</sup> mol L<sup>−1</sup>
```
