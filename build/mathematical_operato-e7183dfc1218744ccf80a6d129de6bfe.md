...
In the first example, the two <i>strings</i> have been placed side-by-side. We call this placing *concatenation*. In the second case, the same string has been concatenated five times.
