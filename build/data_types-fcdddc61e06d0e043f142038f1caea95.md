...
* /first_steps/write_run_python.md
...
````{admonition} Task
The following piece of code only correctly if `mass` is correctly defined as a
number:
...
<details><summary>Solution</summary>
You should have noticed that the number 35 was multiplied incorrectly. This is
because <code>mass</code> was defined as a string, since the number
<code>"32"</code> was written with quotation markss. If you remove the quotation
...
In a few lessons, we will look more closely at how operators (like
...
mass = "35"
double\_mass = mass\*2
print(f"Two times {mass} kg makes {double\_mass} kg.")
```
...
* Common types: numbers, text, booleans.
* Use clear variable names.
* Use f-strings to mix variables with text.
