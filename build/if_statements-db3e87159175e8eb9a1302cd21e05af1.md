...
Write a Python conditional statement that will print whether our peak is background noise or not. If the transmittance is outside of the 0 to 100% range, print an error message.
```
...
if peak_transmittance >= 95 and peak_transmittance <= 100:
    ...
    print(f"The peak has an absorbance of {peak_transmittance}%.")
```
</details>
