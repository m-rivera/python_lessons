...
The first step is to install Python. For this tutorial, we will use the
Miniforge installer.

### Installation

Miniforge is a package which includes Python and `conda`, which will allow us to
download a code editor and Python-related software.
...
3. Search for "Miniforge Prompt" in your programs and open it.
4. Paste `conda create -c conda-forge -n spyder-env spyder numpy scipy pandas
   matplotlib sympy cython` in the prompt and press enter.
