...
This lesson teaches you how to (optionally) install *Python* and an IDE called *Spyder*.

## Python on UCL Desktop
If you are using a UCL Desktop:
- Open "UCL Application Store"
- Search for "Anaconda for Windows" and click "Launch". This will take a few
  minutes.
- Once the Anaconda Navigator window is open, click on "Launch" under the
  "Spyder" application.
- Skip to the section "Write a Python Program"

If you are not on a UCL Desktop, you will need to install Python on your
computer.
