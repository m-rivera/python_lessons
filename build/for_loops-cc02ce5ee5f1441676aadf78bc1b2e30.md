...
```
Just as with `zip()`, we are defining two discrete variables. The first is the index, which will take integer values starting at 0 and increasing by 1 every loop. 