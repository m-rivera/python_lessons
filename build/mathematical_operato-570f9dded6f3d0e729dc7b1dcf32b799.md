...
In the first example, the two *strings* have been placed side-by-side. We call this placing *concatenation*. In the second case, the same string has been concatenated five times.
