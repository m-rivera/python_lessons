...
For the following equation at equilibrium, write a program which calculates the equilibrium constant to 1 decimal place.

2SO<sub>2(g)</sub> + O<sub>2(g)</sub> ⇌ 2SO<sub>3(g)</sub>

Concentrations at equilibrium: <br>
[SO<sub>3</sub>] = 5.0 × 10<sup>−2</sup> <br/>
[O<sub>2</sub>] = 3.5 × 10<sup>−3</sup> <br/>
[SO<sub>2</sub>] = 3.0 × 10<sup>−3</sup> <br/>
```
